...
def build_classifier_prompt(message: str, has_itinerary: bool) -> str:
    return (
        ...
        "- CHECK_LODGING_LEGAL: user asks whether a specific lodging/hotel/guesthouse/民宿/旅館 is legally registered with the government\n"
        ...
        "- EXPLAIN: {subject}\n"
        "- CHECK_LODGING_LEGAL: {lodging_name, phone, district}\n"
        "- CHAT_GENERAL: {topic}\n"
